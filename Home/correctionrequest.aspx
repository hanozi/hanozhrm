<%@ Page Title="" Language="C#" MasterPageFile="~/Home/admin.master" AutoEventWireup="true" CodeFile="correctionrequest.aspx.cs" Inherits="Home_correctionrequest" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" style="width:1200px" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="correctionid">
                <Columns>
                    <asp:TemplateField HeaderText="Request">
                        <ItemTemplate>
                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("request") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Actual Time">
                        <ItemTemplate>
                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("actualtime") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
    ...
    <table style="width:100%;float:left">
        <tr>
            <td colspan="2">Add Correction Request</td>
        </tr>
        <tr>
            <td style="width: 63px; height: 34px;">Request</td>
            <td style="height: 34px">
                <asp:DropDownList ID="DropDownList2" runat="server" Height="50px" Width="200px" Visible="True">
                <asp:ListItem>In Punch Missing</asp:ListItem>
                <asp:ListItem>Out Punch Missing</asp:ListItem>
        ...
        <tr style="margin:100px 100px 100px 100px">
            <td style="width: 63px">Actual Time</td>
