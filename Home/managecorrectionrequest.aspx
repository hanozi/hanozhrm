<%@ Page Title="" Language="C#" MasterPageFile="~/Home/admin.master" AutoEventWireup="true" CodeFile="managecorrectionrequest.aspx.cs" Inherits="Home_managecorrectionrequest" %>
    ...
    <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Request ID">
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("CorrectionID") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="Request">
                <ItemTemplate>
                    <asp:Label ID="Label4" runat="server" Text='<%# Bind("request") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="Actual Time">
                <ItemTemplate>
                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("actualtime") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
