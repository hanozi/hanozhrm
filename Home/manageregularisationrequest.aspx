<%@ Page Title="" Language="C#" MasterPageFile="~/Home/admin.master" AutoEventWireup="true" CodeFile="manageregularisationrequest.aspx.cs" Inherits="Home_manageregularisationrequest" %>
...
<asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Request ID">
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("regularisationid") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
