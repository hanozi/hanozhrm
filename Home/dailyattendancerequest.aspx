    <%@ Page Title="" Language="C#" MasterPageFile="~/Home/admin.master" AutoEventWireup="true" CodeFile="dailyattendancerequest.aspx.cs" Inherits="Home_dailyattendancerequest" %>
...
<asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="View1" runat="server">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" style="width:1200px" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="attrequestid">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Out Time">
                        <ItemTemplate>
                            <asp:Label ID="Label6" runat="server" Text='<%# Bind("outtime") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
    ...
    <table style="width:100%;float:left">
        <tr>
            <td colspan="2">Add Attendance Request</td>
        </tr>
        <tr>
            <td style="width: 63px; height: 34px;">Date</td>
            <td style="height: 34px">
                <asp:TextBox ID="TextBox4" AutoComplete="off" runat="server" Height="50px" Width="200px" TextMode="Date"></asp:TextBox>
            </td>
        </tr>
        <tr style="margin:100px 100px 100px 100px">
            <td style="width: 63px">In Time</td>
            <td style="width: 116px">
            <asp:TextBox ID="TextBox2" AutoComplete="off" runat="server" Height="50px" Width="200px" TextMode="Time"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="width: 63px">Out Time</td>
            <td style="width: 116px"><asp:TextBox ID="TextBox3" AutoComplete="off" runat="server" Height="50px" Width="200px" TextMode="Time"></asp:TextBox></td>
        </tr>
        <tr>
