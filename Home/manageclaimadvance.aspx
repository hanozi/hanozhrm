<%@ Page Title="" Language="C#" MasterPageFile="~/Home/admin.master" AutoEventWireup="true" CodeFile="manageclaimadvance.aspx.cs" Inherits="Home_manageclaimadvance" %>
...
<asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" OnRowDataBound="GridView1_RowDataBound">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Request ID">
                <ItemTemplate>
                    <asp:Label ID="Label14" runat="server" Text='<%# Bind("claimid") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
