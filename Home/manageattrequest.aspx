<%@ Page Title="" Language="C#" MasterPageFile="~/Home/admin.master" AutoEventWireup="true" CodeFile="manageattrequest.aspx.cs" Inherits="Home_manageatrequest" %>
 ...
 <asp:GridView ID="GridView1" runat="server" Width="100%" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4">
        <Columns>
            ...
            <asp:TemplateField HeaderText="Request ID">
                <ItemTemplate>
                    <asp:Label ID="Label2" runat="server" Text='<%# Bind("attrequestid") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="In Time">
                <ItemTemplate>
                    <asp:Label ID="Label5" runat="server" Text='<%# Bind("intime") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
